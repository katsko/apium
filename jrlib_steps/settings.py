"""
Django settings for jrlib_steps project.
...
SECRET_KEY = 'l%8%5o^%+a$7p=a8!$nzpngnk6pq1jo=(05xo%&u%%25^(t&i%'
...
WSGI_APPLICATION = 'jrlib_steps.wsgi.application'
